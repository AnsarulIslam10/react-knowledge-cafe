...
const Blog = ({ blog, handleAddToBookmark, handleMarkAsRead }) => {
  ...
  return (
    <div className="pb-10 border-b-2 mt-10 p-4">
      ...
      <h1 className="text-2xl sm:text-3xl md:text-[40px] font-semibold mt-4 mb-4">
        {title}
      </h1>
      ...
      <button onClick={()=>handleMarkAsRead(id, reading_time)} className="mt-5 text-blue-600 underline text-xl">
        Mark as read
      </button>
    </div>
  );
